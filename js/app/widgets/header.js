    ...
    template:`
            <header class="header">
                <div class="wrapper">
                    <div class="flex">
                        <div class="w20 logo">
                            <img src="/app/views/images/logo.svg" />
                        </div>
                        <div class="w70">
                            <div id="menu">
                                ...
                                <ul :class="{active:menu==1}" v-if="parent.user && parent.user.type=='admin'">
                                    ...
                                    <li><router-link :class="{'router-link-active':$route.path.search('campaign')==1}" to="/campaigns"><i class="fas fa-campaigns"></li></i>
                                    <li><router-link :class="{'router-link-active':$route.path.search('user')==1}" to="/users"><i class="fas fa-users"></li></i>
                                </ul>
