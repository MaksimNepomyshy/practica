export const campaigns = {
    ...
    methods:{
        GetFirstAndLastDate:function(){
            ...
            this.date2 = firstDayOfMonth.toISOString().substring(0,10);
        },
        get:function(){
            var self = this;
        ...
        del:async function () {
            if(await this.$refs.header.$refs.msg.confirmFun("please confirm next action", "do you wnat delete this campaign?")){
                var self = this;
                var data = self.parent.toFormData(self.parent.formData);
